#!/usr/bin/env python3
"""
analyze_repo.py — map repo structure to JSON for vfs-docs tree design.
...
def read_key_commands(root: Path) -> dict:
    ...
    # Cargo.toml (Rust) — works for both single crates and workspaces.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Analyze a repo structure and output JSON for vfs-docs."
    )
