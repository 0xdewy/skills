...
hermes skills install your-username/my-skills/skills/skill-lab
```
...
| Skill | Description |
|-------|-------------|
| [skill-lab](skills/skill-lab/) | Create and publish Claude skills |
...
hermes skills install --force your-username/my-skills/skills/skill-lab
```
