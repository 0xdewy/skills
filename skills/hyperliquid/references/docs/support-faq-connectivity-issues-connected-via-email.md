---
title: Connected via email
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/support/faq/connectivity-issues/connected-via-email.md
section: support
scrape_status: ok
---
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/support/faq/connectivity-issues/connected-via-email.md?ask=<question>
```
