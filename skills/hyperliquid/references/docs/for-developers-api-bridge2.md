---
title: Bridge2
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/bridge2.md
section: api
scrape_status: ok
---
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/bridge2.md?ask=<question>
```
