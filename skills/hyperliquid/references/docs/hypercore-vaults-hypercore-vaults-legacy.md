---
title: HyperCore vaults (legacy)
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/hypercore/vaults/hypercore-vaults-legacy.md
section: hypercore
scrape_status: ok
---
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/hypercore/vaults/hypercore-vaults-legacy.md?ask=<question>
```
