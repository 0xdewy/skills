---
title: Connect mobile via QR code
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/onboarding/connect-mobile-via-qr-code.md
section: onboarding
scrape_status: ok
---
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/onboarding/connect-mobile-via-qr-code.md?ask=<question>
```
