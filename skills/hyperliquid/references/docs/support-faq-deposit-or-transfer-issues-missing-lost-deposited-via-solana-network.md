---
title: Deposited via Solana network
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/support/faq/deposit-or-transfer-issues-missing-lost/deposited-via-solana-network.md
section: support
scrape_status: ok
---
...
* The Solana address can only receive SOL/2Z/BONK/FARTCOIN/PUMP/SPX on the Solana network. Deposits other than the assets listed above or on other networks will fail and not be credited, e.g., Depositing USDC on Solana will fail and not be credited.
  ...
  * If you sent the right token on the right chain and deposited more than the minimum amount, but your SOL/2Z/BONK/FARTCOIN/PUMP/SPX still shows up as “Failed”, reach out to the Unit team, which manages Solana network deposits & withdrawals: [https://app.hyperunit.xyz/support](<https://app.hyperunit.xyz/support >)
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/support/faq/deposit-or-transfer-issues-missing-lost/deposited-via-solana-network.md?ask=<question>
```
