...
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/error-responses.md
section: api
scrape_status: ok
---
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/error-responses.md?ask=<question>
```
