...
source_url: https://hyperliquid.gitbook.io/hyperliquid-docs/trading/perpetual-assets.md
section: trading
scrape_status: ok
---
...
```
GET https://hyperliquid.gitbook.io/hyperliquid-docs/trading/perpetual-assets.md?ask=<question>
```
